...
Attribution
-----------
This project extends image classification from the project ImageClassification_DjangoApp (https://github.com/sharmasw/ImageClassification_DjangoApp) by sharmasw
